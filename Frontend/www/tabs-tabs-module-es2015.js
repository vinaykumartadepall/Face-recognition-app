...
let Tabs_homePage = class Tabs_homePage {
    constructor() { }
};
...
const { FileTransfer, Filesystem } = _capacitor_core__WEBPACK_IMPORTED_MODULE_2__["Plugins"];
let Tabs_match = 
/*
Developed by:
...
*/
class Tabs_match {
    constructor(sanitizer, http, file) {
    ...
    matchFace() {
        ...
        */
        if (!this.selectedFile) {
            this.http.post(this.my_ip + '/imagematch', this.clickedImage).subscribe((res) => {
                // this.getImage();
                console.log("res");
                console.log(res);
        ...
        */
            ...
            this.http.post(this.my_ip + '/imagematch', this.selectedFile).subscribe((res) => {
                // this.getImage();
                this.base64Image = 'data:image/jpg;base64,' + res['boxed_image'];
                this.faceName = res['face_name'];
                this.matched_image = 'data:image/jpg;base64,' + res['matched_image'];
...
class Tabs_upload {
    /* This part of code converts the image in base64 string format to base64 JPEG image */
    constructor(sanitizer, http, file, alertController) {
        this.sanitizer = sanitizer;
        this.http = http;
        this.file = file;
    ...
    */
    ...
    onUpload(name) {
        ...
        if (!this.selectedFile) {
            this.http.post(this.my_ip + '/cameraupload/' + name, this.clickedImage).subscribe(() => { this.isSuccess = true; });
        }
        /* Uploads an image selected from a file along with the name of the person to the backend server using http POST request */
        else {
            this.http.post(this.my_ip + '/imageupload/' + name, this.selectedFile).subscribe(() => { this.isSuccess = true; });
        }
    }
    /*
